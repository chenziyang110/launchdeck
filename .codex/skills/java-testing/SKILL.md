---
name: "java-testing"
description: "Use ONLY when user explicitly requests Java test code, JUnit/Mockito/AssertJ configuration,
...
metadata:
  ...
  source: "templates/passive-skills/java-testing/SKILL.md"
---
