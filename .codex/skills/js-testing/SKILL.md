---
name: "js-testing"
description: "Use ONLY when user explicitly requests JavaScript/TypeScript test code, Vitest/Jest configuration,
...
metadata:
  ...
  source: "templates/passive-skills/js-testing/SKILL.md"
---
