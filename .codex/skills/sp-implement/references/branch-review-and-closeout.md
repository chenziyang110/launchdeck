...
- task lifecycles preserve UI contract coverage and reference the shared epoch;
  ...
  closeout;
- run `uvx --from git+https://github.com/chenziyang110/spec-kit-plus.git@6fbbf08a0b6833bb783ec6b418d567776b197ae4 specify implement closeout --feature-dir '"$FEATURE_DIR"' --format json` when available;
