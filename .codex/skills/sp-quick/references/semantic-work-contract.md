...
Trigger: when project-cognition-backed semantic intake, routing, permission, audit, resume, or final-claim rules affect the quick workflow.

Purpose: Preserve the shared semantic mediation and semantic-audit contract outside the quick main-flow prompt.
