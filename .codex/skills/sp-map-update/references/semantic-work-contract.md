...
Trigger: when project-cognition-backed semantic intake, routing, permission, audit, resume, or final-claim rules affect the map-update workflow.

Purpose: Preserve the shared semantic mediation and semantic-audit contract outside the map-update main-flow prompt.
...
`specify project-cognition`. Run `uvx --from git+https://github.com/chenziyang110/spec-kit-plus.git@4a631657f75460886dbd12ebe48b14fc11cfe0bf specify check`, then
`uvx --from git+https://github.com/chenziyang110/spec-kit-plus.git@4a631657f75460886dbd12ebe48b14fc11cfe0bf specify integration repair`, and re-open the installed command or
