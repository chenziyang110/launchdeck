...
- If `FEATURE_DIR` is not explicit, run `uvx --from git+https://github.com/chenziyang110/spec-kit-plus.git@6fbbf08a0b6833bb783ec6b418d567776b197ae4 specify lane resolve --command tasks --ensure-worktree`; honor a materialized worktree and stop on `uncertain`.
...
7. Run `uvx --from git+https://github.com/chenziyang110/spec-kit-plus.git@6fbbf08a0b6833bb783ec6b418d567776b197ae4 specify hook validate-artifacts --command tasks --feature-dir '<feature-dir>' --format json`, repair or reopen the owning upstream phase on failure, and hand off directly to `$sp-implement` only after a clean result and `next_command: /sp.implement`.
