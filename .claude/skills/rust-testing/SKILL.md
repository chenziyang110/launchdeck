---
name: "rust-testing"
description: "Use ONLY when user explicitly requests Rust test code, cargo-test/rstest/mockall configuration,
...
metadata:
  ...
  source: "templates/passive-skills/rust-testing/SKILL.md"
---
