...
If eligibility fails or the consequence model is no longer bounded, stop with the blocker and route to `/sp-specify` or `/sp-discussion` as recorded by the contract.
