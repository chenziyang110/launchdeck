...
When running `sp-debug` in Claude Code, you are the **leader**, not a freeform debugger.
...
## Claude Code Investigation Routing Contract

When running `sp-debug` in Claude Code, treat `investigating` as a complexity-based leader decision.
