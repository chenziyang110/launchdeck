---
name: "zig-testing"
description: "Use ONLY when user explicitly requests Zig test code, built-in test runner configuration,
...
metadata:
  ...
  source: "templates/passive-skills/zig-testing/SKILL.md"
---
