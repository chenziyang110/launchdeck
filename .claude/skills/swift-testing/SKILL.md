---
name: "swift-testing"
description: "Use ONLY when user explicitly requests Swift test code, XCTest/Swift Testing configuration,
...
metadata:
  ...
  source: "templates/passive-skills/swift-testing/SKILL.md"
---
