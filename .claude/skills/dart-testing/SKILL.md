---
name: "dart-testing"
description: "Use ONLY when user explicitly requests Dart/Flutter test code, flutter_test/mockito configuration,
...
metadata:
  ...
  source: "templates/passive-skills/dart-testing/SKILL.md"
---
