...
- Clean: "clean the build cache safely", "clear local generated cache", "清理缓存".
- Adoption: "make this repo runnable", "start this unknown project", "帮我把这个本地项目跑起来".
...
- Broad destructive requests: reset repo, delete all generated files, remove dependencies, wipe data.
